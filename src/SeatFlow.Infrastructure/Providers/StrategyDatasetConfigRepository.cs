...
namespace SeatFlow.Infrastructure.Providers
{
    ...
    /// 存储于 <c>{configDir}/{strategyId}/{filename}.config.json</c>（相对存储根）。
    /// </summary>
    public class StrategyDatasetConfigRepository
    {
        ...
        private readonly ILogger<StrategyDatasetConfigRepository> _logger;
            ...
            ILogger<StrategyDatasetConfigRepository>? logger = null)
        {
            ...
            _logger = logger ?? NullLogger<StrategyDatasetConfigRepository>.Instance;
        }
